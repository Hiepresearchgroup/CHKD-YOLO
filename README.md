# YOLO-CHKD: A Lightweight Crack Detection Model with Cross-head Knowledge Distillation
...
<img width="784" alt="YOLO-CHKD" src="https://github.com/Hiepresearchgroup/CHKD-YOLO/blob/main/img/Overview-YOLO-CHKD.png">
